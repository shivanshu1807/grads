...
//     const [credentials, setCredentials] = useState({name: "", email: "", phnno: "", companyname:"", pincode: "", address: "", password: "",cpassword: ""}) 
...
//                 </div>
//                 <div className="mb-3">
//                     <label htmlFor="phnno" className="form-label">phnno</label>
//                     <input type="phno" className="form-control" id="phno" name='phno' onChange={onChange}  />
//                 </div>
//                 <div className="mb-3">
//                     <label htmlFor="companyname" className="form-label">Company Name</label>
//                     <input type="companyname" className="form-control" id="companyname" name='companyname' onChange={onChange} aria-describedby="companyname" />
//                 </div>
//                 <div className="mb-3">
//                     <label htmlFor="pincode" className="form-label">pincode</label>
//                     <input type="pincode" className="form-control" id="pincode" name='pincode' onChange={onChange} aria-describedby="pincode" />
//                 </div>
//                 <div className="mb-3">
//                     <label htmlFor="address" className="form-label">Address</label>
//                     <input type="address" className="form-control" id="address" name='address' onChange={onChange} aria-describedby="address" />
//                 </div>
//                 <div className="mb-3">
